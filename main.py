...
BOT_API_KEY = '6638668970:AAGOIj21OyT-1MphTUdVfIXQO_iumETLeq0'
bot = telebot.TeleBot(BOT_API_KEY)

# Replace with your actual user ID for testing
OWNER_ID = 5371579102  # Replace with the owner ID
AUTHORIZED_USER_IDS = [OWNER_ID]  # Add other authorized user IDs to this list
PREMIUM_GROUP_ID = -1002201907702  # Replace with your group ID for sending approved CCs
